...
(function (reflect) {
    ...
    (function (SymbolFlags) {
        ...
        SymbolFlags[SymbolFlags["ConstEnum"] = 0x00000080] = "ConstEnum";
        SymbolFlags[SymbolFlags["RegularEnum"] = 0x00000100] = "RegularEnum";
        SymbolFlags[SymbolFlags["ValueModule"] = 0x00000200] = "ValueModule";
        SymbolFlags[SymbolFlags["NamespaceModule"] = 0x00000400] = "NamespaceModule";
        SymbolFlags[SymbolFlags["TypeLiteral"] = 0x00000800] = "TypeLiteral";
        SymbolFlags[SymbolFlags["ObjectLiteral"] = 0x00001000] = "ObjectLiteral";
        SymbolFlags[SymbolFlags["Method"] = 0x00002000] = "Method";
        SymbolFlags[SymbolFlags["Constructor"] = 0x00004000] = "Constructor";
        SymbolFlags[SymbolFlags["GetAccessor"] = 0x00008000] = "GetAccessor";
        SymbolFlags[SymbolFlags["SetAccessor"] = 0x00010000] = "SetAccessor";
        SymbolFlags[SymbolFlags["CallSignature"] = 0x00020000] = "CallSignature";
        SymbolFlags[SymbolFlags["ConstructSignature"] = 0x00040000] = "ConstructSignature";
        SymbolFlags[SymbolFlags["IndexSignature"] = 0x00080000] = "IndexSignature";
        SymbolFlags[SymbolFlags["TypeParameter"] = 0x00100000] = "TypeParameter";
        SymbolFlags[SymbolFlags["TypeAlias"] = 0x00200000] = "TypeAlias";
        // Export markers (see comment in declareModuleMember in binder)
        SymbolFlags[SymbolFlags["ExportValue"] = 0x00400000] = "ExportValue";
        SymbolFlags[SymbolFlags["ExportType"] = 0x00800000] = "ExportType";
        SymbolFlags[SymbolFlags["ExportNamespace"] = 0x01000000] = "ExportNamespace";
        SymbolFlags[SymbolFlags["Import"] = 0x02000000] = "Import";
        SymbolFlags[SymbolFlags["Instantiated"] = 0x04000000] = "Instantiated";
        SymbolFlags[SymbolFlags["Merged"] = 0x08000000] = "Merged";
        SymbolFlags[SymbolFlags["Transient"] = 0x10000000] = "Transient";
        SymbolFlags[SymbolFlags["Prototype"] = 0x20000000] = "Prototype";
        SymbolFlags[SymbolFlags["UnionProperty"] = 0x40000000] = "UnionProperty";
        SymbolFlags[SymbolFlags["Enum"] = SymbolFlags.RegularEnum | SymbolFlags.ConstEnum] = "Enum";
        ...
        SymbolFlags[SymbolFlags["RegularEnumExcludes"] = (SymbolFlags.Value | SymbolFlags.Type) & ~(SymbolFlags.RegularEnum | SymbolFlags.ValueModule)] = "RegularEnumExcludes";
        SymbolFlags[SymbolFlags["ConstEnumExcludes"] = (SymbolFlags.Value | SymbolFlags.Type) & ~SymbolFlags.ConstEnum] = "ConstEnumExcludes";
        SymbolFlags[SymbolFlags["ValueModuleExcludes"] = SymbolFlags.Value & ~(SymbolFlags.Function | SymbolFlags.Class | SymbolFlags.RegularEnum | SymbolFlags.ValueModule)] = "ValueModuleExcludes";
...
(function (reflect) {
    ...
    reflect.processRootFileAsync = processRootFileAsync;
    function processExternalModule(moduleName, searchPath) {
        var isRelative = reflect.isExternalModuleNameRelative(moduleName);
        if (!isRelative) {
            var symbol = reflect.getSymbol(reflect.globals, '"' + moduleName + '"', 512 /* ValueModule */);
            if (symbol) {
    ...
    function bindPendingFilesAsync(callback) {
        ...
        function processFiles() {
            ...
            callback(reflect.hasDiagnosticErrors ? reflect.createDiagnosticError() : null);
        }
    }
    ...
    function processSourceFileAsync(filename, isDefaultLib, refFile, callback) {
        ...
        function handleCallback(err, file, diagnostic) {
            ...
            if (diagnostic) {
                ...
                return callback(reflect.createDiagnosticError(), null);
            }
            callback(null, file);
        }
    }
    ...
    function findSourceFileAsync(filename, isDefaultLib, refFile, callback) {
        ...
        readSourceFileAsync(filename, function (err, file) {
            if (err) {
                reflect.addDiagnostic(new reflect.Diagnostic(refFile, reflect.Diagnostics.Cannot_read_file_0_Colon_1, filename, err.message));
                return callback(reflect.createDiagnosticError(), null);
            }
...
(function (reflect) {
    var SymbolImpl = (function () {
        ...
        SymbolImpl.prototype.getId = function () {
            return this.id;
        };
        ...
        SymbolImpl.prototype.getValue = function (obj) {
            if (!this.name || (this.flags & (4 /* Property */ | reflect.SymbolFlags.Variable | reflect.SymbolFlags.Accessor)) === 0) {
        ...
        SymbolImpl.prototype.getType = function () {
            ...
            var ret = reflect.getTypeOfSymbol(this);
            if (reflect.hasDiagnosticErrors) {
                reflect.throwDiagnosticError();
            }
            return ret;
        ...
        SymbolImpl.prototype.getExports = function (flags) {
            if (flags === void 0) { flags = reflect.SymbolFlags.Value | reflect.SymbolFlags.Type | reflect.SymbolFlags.Namespace; }
            var ret = reflect.getExportedSymbols(this.exports, flags);
            if (reflect.hasDiagnosticErrors) {
                reflect.throwDiagnosticError();
            }
            return ret;
        ...
        SymbolImpl.prototype.isVariable = function () {
            return (this.flags & reflect.SymbolFlags.Variable) !== 0;
        };
        ...
        SymbolImpl.prototype.isEnum = function () {
            return (this.flags & reflect.SymbolFlags.Enum) !== 0;
        };
    ...
    function hasAnnotation(name, container) {
    ...
    var AnnotationImpl = (function () {
        function AnnotationImpl(annotation, declaration) {
            this.declaration = declaration;
            this.name = annotation.name;
            this.value = annotation.value;
        }
        AnnotationImpl.prototype.getDeclarationFileName = function () {
            return reflect.getSourceFile(this.declaration).filename;
        };
...
(function (reflect) {
    function bindSourceFile(file) {
        ...
        function getModuleInstanceState(node) {
            ...
            else if (node.kind === 4 /* ModuleDeclaration */) {
        ...
        function bindConstructorDeclaration(node) {
            ...
            reflect.forEach(node.parameters, function (p) {
                if (p.flags & (16 /* Public */ | 32 /* Private */ | 64 /* Protected */)) {
                    bindDeclaration(p, 4 /* Property */, reflect.SymbolFlags.PropertyExcludes, false);
                }
            });
        }
        function bindModuleDeclaration(node) {
            if (node.flags & 16384 /* ExternalModule */) {
                bindDeclaration(node, 512 /* ValueModule */, reflect.SymbolFlags.ValueModuleExcludes, true);
            }
            else {
        ...
        function bindBlockScopedVariableDeclaration(node) {
            switch (blockScopeContainer.kind) {
                case 4 /* ModuleDeclaration */:
                    declareModuleMember(node, 2 /* BlockScopedVariable */, reflect.SymbolFlags.BlockScopedVariableExcludes);
                    break;
                case 0 /* SourceFile */:
                    if (node.flags & 16384 /* ExternalModule */) {
                        declareModuleMember(node, 2 /* BlockScopedVariable */, reflect.SymbolFlags.BlockScopedVariableExcludes);
                ...
                default:
                    ...
                    declareSymbol(blockScopeContainer.locals, undefined, node, 2 /* BlockScopedVariable */, reflect.SymbolFlags.BlockScopedVariableExcludes);
            }
        ...
        function bind(node) {
            ...
            switch (node.kind) {
                case 30 /* TypeParameter */:
                    bindDeclaration(node, 1048576 /* TypeParameter */, reflect.SymbolFlags.TypeParameterExcludes, false);
                    break;
                case 29 /* Parameter */:
                    bindDeclaration(node, 1 /* FunctionScopedVariable */, reflect.SymbolFlags.ParameterExcludes, false);
                    break;
                case 6 /* VariableDeclaration */:
                    ...
                    if (node.flags & 6144 /* BlockScoped */) {
                        ...
                        bindDeclaration(node, 1 /* FunctionScopedVariable */, reflect.SymbolFlags.FunctionScopedVariableExcludes, false);
                    }
                    break;
                case 11 /* Field */:
                case 16 /* PropertySignature */:
                    bindDeclaration(node, 4 /* Property */, reflect.SymbolFlags.PropertyExcludes, false);
                    break;
                case 9 /* EnumMember */:
                    bindDeclaration(node, 8 /* EnumMember */, reflect.SymbolFlags.EnumMemberExcludes, false);
                    break;
                case 20 /* CallSignature */:
                ...
                case 18 /* MethodSignature */:
                    ...
                    bindDeclaration(node, 8192 /* Method */, isObjectLiteralMethod(node) ? reflect.SymbolFlags.PropertyExcludes : reflect.SymbolFlags.MethodExcludes, true);
                    break;
                case 19 /* IndexSignature */:
                    bindDeclaration(node, 524288 /* IndexSignature */, 0, false);
                    break;
                case 5 /* FunctionDeclaration */:
                    bindDeclaration(node, 16 /* Function */, reflect.SymbolFlags.FunctionExcludes, true);
                    break;
                case 13 /* Constructor */:
                    bindConstructorDeclaration(node);
                    break;
                case 14 /* GetAccessor */:
                    bindDeclaration(node, 32768 /* GetAccessor */, reflect.SymbolFlags.GetAccessorExcludes, true);
                    break;
                case 15 /* SetAccessor */:
                    bindDeclaration(node, 65536 /* SetAccessor */, reflect.SymbolFlags.SetAccessorExcludes, true);
                    break;
                case 23 /* ConstructorType */:
                case 21 /* FunctionType */:
                ...
                case 24 /* ObjectType */:
                    ...
                    break;
                case 2 /* ClassDeclaration */:
                    bindDeclaration(node, 32 /* Class */, reflect.SymbolFlags.ClassExcludes, false);
                    break;
                case 1 /* InterfaceDeclaration */:
                    bindDeclaration(node, 64 /* Interface */, reflect.SymbolFlags.InterfaceExcludes, false);
                    break;
                case 8 /* TypeAliasDeclaration */:
                    bindDeclaration(node, 2097152 /* TypeAlias */, reflect.SymbolFlags.TypeAliasExcludes, false);
                    break;
                case 3 /* EnumDeclaration */:
                    if (isConst(node)) {
                        bindDeclaration(node, 128 /* ConstEnum */, reflect.SymbolFlags.ConstEnumExcludes, false);
                    }
                    else {
                        bindDeclaration(node, 256 /* RegularEnum */, reflect.SymbolFlags.RegularEnumExcludes, false);
                    }
                    break;
                case 4 /* ModuleDeclaration */:
                ...
                case 7 /* ImportDeclaration */:
                    bindDeclaration(node, 33554432 /* Import */, reflect.SymbolFlags.ImportExcludes, false);
                    break;
                case 0 /* SourceFile */:
                    if (node.flags & 16384 /* ExternalModule */) {
    ...
    function isObjectLiteralMethod(node) {
        return node !== undefined && node.kind === 12 /* Method */ && node.parent.kind === 24 /* ObjectType */;
    }
...
(function (reflect) {
    var TypeImpl = (function () {
        ...
        TypeImpl.prototype.getId = function () {
            return this.id;
        };
        ...
        TypeImpl.prototype.isArray = function () {
            return this.hasBaseType(reflect.globalArrayType);
        };
        ...
        TypeImpl.prototype.getElementType = function () {
            ...
            function getArrayReference(type) {
                ...
                if (target === reflect.globalArrayType) {
                    return type;
                }
        ...
        TypeImpl.prototype.createObject = function (args) {
        ...
        TypeImpl.prototype._getImplementation = function () {
            ...
            if (!moduleSymbol) {
                ...
                var name = reflect.symbolToString(this.symbol);
            }
            else {
                ...
                var name = reflect.symbolToString(this.symbol, reflect.getResolvedExportSymbol(moduleSymbol));
            }
            if (name) {
                var path = name.split('.');
...
(function (reflect) {
    var SignatureImpl = (function () {
        ...
        SignatureImpl.prototype.hasAnnotation = function (name) {
            return reflect.hasAnnotation(name, this);
        };
...
(function (reflect) {
    ...
    reflect.getExportedSymbols = getExportedSymbols;
    ...
    function resolveExternalModuleName(location, moduleName) {
        ...
        if (!isRelative) {
            var symbol = getSymbol(reflect.globals, '"' + moduleName + '"', 512 /* ValueModule */);
            if (symbol) {
    ...
    function getTypeOfSymbol(symbol) {
        ...
        if (symbol.flags & (reflect.SymbolFlags.Variable | 4 /* Property */)) {
            return getTypeOfVariableOrParameterOrProperty(symbol);
        }
        if (symbol.flags & (16 /* Function */ | 8192 /* Method */ | 32 /* Class */ | reflect.SymbolFlags.Enum | 512 /* ValueModule */)) {
    ...
    reflect.getInterfaceBaseTypeNodes = getInterfaceBaseTypeNodes;
    ...
    function getDeclaredTypeOfSymbol(symbol) {
        ...
        if (symbol.flags & reflect.SymbolFlags.Enum) {
    ...
    function resolveAnonymousTypeMembers(type) {
        ...
        if (symbol.flags & 2048 /* TypeLiteral */) {
            ...
            var numberIndexType = (symbol.flags & reflect.SymbolFlags.Enum) ? stringType : undefined;
        }
        setObjectTypeMembers(type, members, callSignatures, constructSignatures, stringIndexType, numberIndexType);
    }
    ...
    function getSignaturesOfObjectOrUnionType(type, kind) {
        if (type.flags & (reflect.TypeFlags.ObjectType | 16384 /* Union */)) {
            var resolved = resolveObjectOrUnionTypeMembers(type);
    ...
    reflect.getIndexTypeOfObjectOrUnionType = getIndexTypeOfObjectOrUnionType;
    ...
    function getRestTypeOfSignature(signature) {
        if (signature.hasRestParameter) {
            ...
            if (type.flags & 4096 /* Reference */ && type.target === reflect.globalArrayType) {
    ...
    function createArrayType(elementType) {
        ...
        var arrayType = reflect.globalArrayType || getDeclaredTypeOfSymbol(globalArraySymbol);
    ...
    function checkTypeRelatedTo(source, target, relation, diagnostics) {
        ...
        function isRelatedTo(source, target, reportErrors) {
            ...
            if (source.flags & 16384 /* Union */) {
                ...
                if (sourceOrApparentType.flags & reflect.TypeFlags.ObjectType && target.flags & reflect.TypeFlags.ObjectType && (result = objectTypeRelatedTo(sourceOrApparentType, target, reportStructuralErrors))) {
    ...
    function initializeGlobalTypes() {
        ...
        reflect.globalArrayType = getTypeOfGlobalSymbol(globalArraySymbol, 1);
...
(function (reflect) {
    ...
    function load(paths, callback) {
        ...
        function processFile(filePath, callback) {
            reflect.processRootFileAsync(filePath, function (err, sourceFile) {
                if (err)
                    return callback(err);
                var symbol = sourceFile.symbol;
                if (symbol) {
                    symbol = reflect.getResolvedExportSymbol(sourceFile.symbol);
                }
                symbols.push(symbol);
                callback();
            });
