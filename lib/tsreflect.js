...
(function (reflect) {
    var TypeImpl = (function () {
        ...
        TypeImpl.prototype.getEnumValue = function (value, ignoreCase) {
            ...
            var enumImplementation = reflect.getImplementationOfType(this);
            if (!ignoreCase) {
        ...
        TypeImpl.prototype.getReferenceTarget = function () {
            if (!this.isReference()) {
...
(function (reflect) {
    ...
    var cachedImplementation = [];
    function getImplementationOfType(classType) {
        ...
        if (!moduleSymbol) {
            ...
            var name = reflect.symbolToString(classType.symbol);
        }
        else {
    ...
    reflect.getImplementationOfType = getImplementationOfType;
