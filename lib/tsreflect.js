...
(function (reflect) {
    var TypeImpl = (function () {
        ...
        TypeImpl.prototype.hasAnnotation = function (name, inherit) {
            ...
            if (inherit) {
                return reflect.forEach(this.baseTypes, function (baseType) { return baseType.hasAnnotation(name, inherit); });
            }
            return false;
        };
        ...
        TypeImpl.prototype._getBaseClass = function () {
            ...
            return this._baseClass = null || reflect.forEach(this.baseTypes, function (baseType) {
                var type = baseType._getTargetType();
                if (type.flags & 1024 /* Class */) {
                    return type;
                }
            });
        };
...
(function (reflect) {
    var SymbolImpl = (function () {
        ...
        SymbolImpl.prototype.getValue = function (obj) {
            if (!this.name || (this.flags & (2 /* Property */ | 1 /* Variable */ | reflect.SymbolFlags.Accessor)) === 0) {
    ...
    function getExportedSymbols(symbols, flags) {
        ...
        for (var name in symbols) {
            if (symbols.hasOwnProperty(name)) {
                ...
                else if (symbol.flags & 4194304 /* Import */) {
