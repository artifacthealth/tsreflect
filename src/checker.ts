...
module reflect {
    ...
    export function createTypeChecker(loader: Loader): TypeChecker {
        ...
        function createSymbol(flags: SymbolFlags, name: string): Symbol {
            return new SymbolImpl(checker, flags, name);
        }
        ...
        function getExportedSymbols(symbols: SymbolTable, flags: SymbolFlags): Symbol[] {
        ...
        function createType(flags: TypeFlags): Type {
            var result = new TypeImpl(checker, flags);
            result.id = typeCount++;
            return result;
        }
        ...
        function getInterfaceBaseTypeNodes(node: InterfaceDeclaration) {
            return node.extends;
        }
        ...
        function createSignature(declaration: SignatureDeclaration, typeParameters: TypeParameter[], parameters: Symbol[],
            ...
            var sig = new SignatureImpl(checker);
        ...
        function symbolToString(symbol: Symbol, containingSymbol?: Symbol): string {
        ...
        function isTypeIdenticalTo(source: Type, target: Type, diagnostics?: Diagnostic[]): boolean {
            return checkTypeRelatedTo(source, target, identityRelation, diagnostics);
        }

        function isTypeSubtypeOf(source: Type, target: Type, diagnostics?: Diagnostic[]): boolean {
            return checkTypeRelatedTo(source, target, subtypeRelation, diagnostics);
        }

        function isTypeAssignableTo(source: Type, target: Type, diagnostics?: Diagnostic[]): boolean {
